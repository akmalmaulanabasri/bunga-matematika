        ...
        <div class="col-11">
            <div class="card card-me">
                <div class="card-head">
                    ...
                    <h3 class="text-center">Future Value</h3>
                </div>
                <div class="card-body">
                    <form action="index.php?hitung=future" method="post" class="form-group">
                        <label for="pinjaman" class="form-label">Besar Pinjaman</label>
                        <input required type="number" name="pinjaman" id="pinjaman" placeholder="Pinjaman Awal" class="form-control">
